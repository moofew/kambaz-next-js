...
export const updateCourse = async (course: Course & { _id: string }) => {
...
export const updateModule = async (courseId: string, module: Module & { _id: string }) => {
...
export const updateAssignment = async (assignment: Assignment & { _id: string }) => {
