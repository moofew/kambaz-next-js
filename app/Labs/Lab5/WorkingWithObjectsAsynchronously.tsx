...
export default function WorkingWithArraysAsynchronously() {
  ...
  return (
    <div id="wd-asynchronous-arrays">
      ...
      <h4>Todos <FaPlusCircle onClick={createNewTodo} className="text-success float-end fs-3" /><FaPlusCircle onClick={postNewTodo}   className="text-primary float-end fs-3 me-3" id="wd-post-todo"   /></h4>
      <ListGroup>
        {todos.map((todo) => (
