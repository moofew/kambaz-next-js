        ...
        <div id = "wd-lab1">
            ...
            <div id="wd-lists">
                ...
                <ol id="wd-your-favorite-recipe">
                    <li>Boil an egg for 8 minutes.</li>
                    <li>Rinse egg with cold water for 1 minute.</li>
                    <li>Peel the egg.</li>
                    <li>Add sauce to the egg(anything works!).</li>
                    <li>Serve and enjoy!</li>
                </ol>
            ...
            alt="Starship"/>
                ...
                <br />
                <Image id="wd-teslabot" src="/images/teslabot.jpg" width={300} height={200} alt="Tesla Bot" />
            </div>
            <div id="wd-forms">
                <h4>Form Elements</h4>
